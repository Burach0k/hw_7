...
def get_shop_list_by_dishes(dishes, person_count):
    ...
    return reduce(
        lambda prev_dishe, dishe: dish_count_info_reducer(prev_dishe, cook_book[dishe], person_count),
        dishes,
        {}
    )
...
def dish_count_info_reducer(prev_dishe, dishe_info_list, person_count):
    item = reduce(
        lambda prev_element, dishe_info: dish_ifno_reduce(prev_element, dishe_info, person_count),
        dishe_info_list,
        {}
    )
